...
public class XoaiSayDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        XoaiSayGlobalFeatureConfigurator.Configure();
        XoaiSayModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<XoaiSayDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<XoaiSayResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/XoaiSay");

            options.DefaultResourceType = typeof(XoaiSayResource);
        ...
        {
            options.MapCodeNamespace("XoaiSay", typeof(XoaiSayResource));
        });
    }
}
